...
export default function Auth() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const looksTaken =
        username.trim().toLowerCase().includes('taken') ||
        email.trim().toLowerCase().endsWith('@taken.com')
      if (looksTaken) {
        setAvailabilityMessage('Email or username appears to be taken.')
      } else {
        setAvailabilityMessage('Email and username look available.')
      }
      setIsCheckingAvailability(false)
    }, 500)
      ...
      <div className="relative w-full h-screen md:h-screen overflow-hidden bg-zinc-950">
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            <div className="relative max-w-md space-y-4 rounded-xl border border-zinc-800 bg-black/75 backdrop-blur-1xl p-6 text-center shadow-[0_20px_80px_rgba(0,0,0,0.45)] z-30">
              <h1 className="text-6xl font-extrabold tracking-tight bg-gradient-to-r from-cyan-400 via-purple-400 to-blue-500 bg-clip-text text-transparent">
                Lattice Chat
              </h1>
              ...
              <p className="text-black-500 text-sm leading-relaxed">
                ...
                <span className="text-purple-400 font-semibold"> Kyber lattice algorithm</span>,
                designed to remain secure even against future quantum computers.
              </p>

              <div className="flex justify-center gap-4 pt-2 text-[11px] font-mono text-black-500">
        ...
        <div className="relative z-10 grid h-full grid-cols-1 md:grid-cols-3">
                ...
                >
                  <div className="space-y-2 mb-6 text-left">
                    ...
                    <p className="text-zinc-500 text-sm">
                      Join to start messaging securely
                    </p>
                  </div>
                      ...
                      <div
                        className={`mt-2 rounded-lg border px-3 py-2 text-xs ${
                          isCheckingAvailability
                            ...
                            : availabilityMessage
                              ? availabilityMessage.includes('taken')
                      ...
                      >
                        <p className="font-mono">
                          {isCheckingAvailability
                            ...
                            : (availabilityMessage ??
                              'Enter email & username to check availability.')}
                        </p>
                      </div>
          ...
          <div className="flex items-center p-8 md:col-start-3">
            <AnimatePresence mode="wait">
              {mode === 'login' && (
                <motion.div
                  key="login"
